...
public class MailDeCompraVO implements MailVO {
    ...
    public MailDeCompraVO(List<FilaResumenCompraRequest> filaResumenCompraRequest, UsuarioInvitadoEntity usuarioInvitadoEntity, OrdenEntregaInvitadoEntity ordenEntregaInvitadoEntity) {
