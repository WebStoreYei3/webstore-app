...
class SendAuthentication
{
    ...
    public static void Send()
    {
        ...
        String host ="gemobile.mx";//Suponiendo que el servidor SMTPsea la propia máquina
        String from ="supportgemobile@gemobile.mx";
...
class SMTPAuthentication extends javax.mail.Authenticator
{
    ...
    public PasswordAuthentication getPasswordAuthentication()
    {
        ...
        String username = "supportgemobile@gemobile.mx";
